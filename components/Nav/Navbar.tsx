	...
	return (
		<>
			<nav
				...
				} flex-col absolute bg-[#090909] z-50 top-[112px] left-0 w-screen h-[calc(100vh-112px)] justify-between py-[80px] sm:py-[120px] md:py-0 md:flex md:flex-row md:static md:w-auto md:h-auto md:bg-transparent gap-8 items-center text-sm tracking-widest`}>
				<Link href='/' className='hover:text-gray-100 transition-colors text-2xl md:text-base'>
					Home
				</Link>
